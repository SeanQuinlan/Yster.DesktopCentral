function Get-DCDeploymentPolicies {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        ...
        Returns all deployment policies.
    .NOTES
        https://www.manageengine.com/patch-management/api/deployment-policies-patch-management.html
    #>
    ...
    try {
        ...
        $API_Path = Add-Filters -BoundParameters $PSBoundParameters -BaseURL 'patch/deploymentpolicies'
        $Query_Parameters = @{
            'AuthToken'            = $AuthToken
            'HostName'             = $HostName
            'APIPath'              = $API_Path
