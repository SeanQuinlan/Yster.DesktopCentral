function Get-DCSoftwareLicense {
    <#
    .SYNOPSIS
        Returns all software licenses in the environment.
    .DESCRIPTION
    ...
    try {
        $API_Path = Add-Filters -BoundParameters $PSBoundParameters -BaseURL 'inventory/licensesoftware'
        $Query_Parameters = @{
            'AuthToken'            = $AuthToken
            'HostName'             = $HostName
            'APIPath'              = $API_Path
