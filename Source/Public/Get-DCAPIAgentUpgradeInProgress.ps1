function Get-DCAPIAgentUpgradeInProgress {
    ...
    .EXAMPLE
        Get-DCAPIAgentUpgradeInProgress -HostName DCSERVER -AuthToken '47A1157A-7AAC-4660-XXXX-34858F3A001C' -ResourceName SRV1

        Returns $true if computer "SRV1" has an agent upgrade is in progress, otherwise returns $false.
    .NOTES
    #>
