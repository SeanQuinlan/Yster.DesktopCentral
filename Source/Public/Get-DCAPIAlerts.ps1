function Get-DCAPIAlerts {
    ...
    .EXAMPLE
        ...
        Gets a list of all configured alerts from the server.
    .NOTES
    #>
    ...
    try {
        $API_Path = Add-Filters -BoundParameters $PSBoundParameters -BaseURL 'dcapi/inventory/configureAlerts'
        $Query_Parameters = @{
            'AuthToken'            = $AuthToken
            'HostName'             = $HostName
            'APIPath'              = $API_Path
