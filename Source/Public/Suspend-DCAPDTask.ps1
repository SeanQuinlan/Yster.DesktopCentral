function Suspend-DCAPDTask {
    ...
    .EXAMPLE
        ...
        Suspends the APD task with the name "APDTask1".
    .NOTES
        https://www.manageengine.com/patch-management/api/suspend-apd-task.html
    #>
    ...
    try {
        ...
        [void]$ShouldProcess_Statement.AppendLine(('Suspend APD task: {0}' -f $TaskName))
