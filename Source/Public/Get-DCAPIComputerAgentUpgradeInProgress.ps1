function Get-DCAPIComputerAgentUpgradeInProgress {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        Get-DCAPIComputerAgentUpgradeInProgress -HostName DCSERVER -AuthToken '47A1157A-7AAC-4660-XXXX-34858F3A001C' -ResourceID 101
