function Get-DCAPIComputerSecurity {
    ...
    .DESCRIPTION
        Returns firewall, BitLocker and Anti-Virus security information for the specified resource.
    .EXAMPLE
    ...
    .EXAMPLE
        Get-DCAPIComputerSecurity -HostName DCSERVER -AuthToken '47A1157A-7AAC-4660-XXXX-34858F3A001C' -ResourceName SRV1 -Type 'bitlocker'

        Displays the bitlocker security details for the computer with name "SRV1".
    .NOTES
    #>
