function Get-DCAvailableResource {
    <#
    .SYNOPSIS
        Returns a list of resources, filtered by the supplied parameters
    .DESCRIPTION
    .EXAMPLE
        Get-DCAvailableResource -HostName DCSERVER -AuthToken '47A1157A-7AAC-4660-XXXX-34858F3A001C'
